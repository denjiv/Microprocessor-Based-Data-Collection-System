...
void write_sram_16(uint8_t addr, float data);

// Writing to each sensor
void write_sram_freq(float data);
void write_sram_sal(float data);
void write_sram_car(float data);
void write_sram_temp(float data);

// reading from sensor data (16 measurements)
void read_sram_sensor(uint8_t strAddr, float * val);
